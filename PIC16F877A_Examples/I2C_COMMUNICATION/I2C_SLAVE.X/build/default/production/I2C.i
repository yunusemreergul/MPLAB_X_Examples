...
# 8 "I2C.c" 2
    ...
    void I2C_Master_Initialize(I2C_BaudRate_t I2C_BaudRate, Slew_Rate_t I2C_SMP_OnOff, SMBus_t I2C_CKE_OnOff){
        SSPSTAT = (I2C_SMP_OnOff<<7)|(I2C_CKE_OnOff<<6);
        SSPCON = 0b00101000;
        SSPCON2 = 0x00;
        SSPADD = (20000000UL/(4*I2C_BaudRate)) - 1;
        TRISCbits.TRISC3 = 1;
        TRISCbits.TRISC4 = 1;
    }

    static __attribute__((inline)) void I2C_Master_Check_Idle(void){
        while((SSPSTATbits.R_nW)||(SSPCON2bits.SEN)||(SSPCON2bits.RSEN)||(SSPCON2bits.PEN)||(SSPCON2bits.RCEN)||(SSPCON2bits.ACKEN));
    }
    ...
    void I2C_Slave_Initialize(I2C_Slave_Mode_t I2C_Slave_Mode, I2C_Slave_Address_t I2C_Slave_Address, Slew_Rate_t I2C_SLEW_OnOff, SMBus_t I2C_SMBus_OnOff){
        SSPSTAT = (I2C_SLEW_OnOff<<7)|(I2C_SMBus_OnOff<<6);
        SSPCON = (0b00100000)|(I2C_Slave_Mode);
        SSPCON2 = 0x01;
    ...
    unsigned char I2C_Slave_Receive(void){
        I2C_Slave_Check_Overflow_And_Collision();
            ...
            if(SSPSTATbits.D_nA == 0 && SSPSTATbits.R_nW == 0){
                uint8_t dummy = SSPBUF;
                SSPCONbits.CKP = 1;
            }else if(SSPSTATbits.D_nA == 1 && SSPSTATbits.R_nW == 0){
