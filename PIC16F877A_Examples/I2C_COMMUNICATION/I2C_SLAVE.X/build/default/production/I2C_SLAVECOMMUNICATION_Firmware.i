# 1 "I2C_SLAVECOMMUNICATION_Firmware.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "I2C_SLAVECOMMUNICATION_Firmware.c" 2
...
# 8 "I2C_SLAVECOMMUNICATION_Firmware.c" 2
...
# 9 "I2C_SLAVECOMMUNICATION_Firmware.c" 2
    ...
    void main(void){
        ...
        I2C_Slave_Initialize(((I2C_Slave_Mode_t)0b0110), ((I2C_Slave_Address_t)0x40), ((Slew_Rate_t)1), ((SMBus_t)0));
    ...
    void I2C_Slave_ISR_Handler_Function(void){
        ...
        if(PIR1bits.SSPIF){
            I2C_Slave_Transmit(Slave_TX_Data);
