# 1 "I2C_LCD_v2.0_DISPLA_Firmware.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "I2C_LCD_v2.0_DISPLA_Firmware.c" 2
...
# 9 "I2C_LCD_v2.0_DISPLA_Firmware.c" 2
...
# 10 "I2C_LCD_v2.0_DISPLA_Firmware.c" 2
...
# 11 "I2C_LCD_v2.0_DISPLA_Firmware.c" 2
...
void main(void){
    ...
    I2C_LCD_init(&LCD2, 0x4E, 0x08, 0x00);
    ...
    while(1){
        for(int i=0;i<6;i++){
            I2C_LCD_cursor_or_display_shift(LCD1, 0x08, 0x04);
            _delay((unsigned long)((250)*(20000000UL/4000.0)));
        }
        for(int i=6;i>0;i--){
            I2C_LCD_cursor_or_display_shift(LCD1, 0x08, 0x00);
            _delay((unsigned long)((250)*(20000000UL/4000.0)));
        }
    }
    return;
