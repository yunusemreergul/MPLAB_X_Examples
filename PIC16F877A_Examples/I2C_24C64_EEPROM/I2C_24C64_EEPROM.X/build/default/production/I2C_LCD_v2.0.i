...
# 64 "./I2C_LCD_v2.0.h"
    ...
    const unsigned char Lcd_RW_State = 0x00;
    unsigned char BackLight_State = 0x08;
# 123 "./I2C_LCD_v2.0.h"
...
# 1 "./PCF8574_IO_Expander_v1.0.h" 1
# 17 "./PCF8574_IO_Expander_v1.0.h"
...
# 13 "I2C_LCD_v2.0.c" 2
    ...
    static void LCD_data_sender(I2C_LCD_t LCD_Obj, uint8_t data, p_I2C_IO_Expander_Writer_t callback_function){
        callback_function(LCD_Obj.Address, (data&0xF0) | Lcd_RS_State | Lcd_RW_State | 0x04 | LCD_Obj.BackLight_State);
        callback_function(LCD_Obj.Address, (data&0xF0) | Lcd_RS_State | Lcd_RW_State | 0x00 | LCD_Obj.BackLight_State);
        callback_function(LCD_Obj.Address, ((data<<4)&0xF0) | Lcd_RS_State | Lcd_RW_State |0x04 | LCD_Obj.BackLight_State);
        callback_function(LCD_Obj.Address, ((data<<4)&0xF0) | Lcd_RS_State | Lcd_RW_State |0x00 | LCD_Obj.BackLight_State);
    }
    ...
    void I2C_LCD_write_string(I2C_LCD_t LCD_Obj, char *str){
        uint8_t i;
        for(i=0;str[i]!='\0';i++){
            if(str[i]=='\n') p_LCD_send_commad(LCD_Obj, (0xC0 - 1));
            I2C_LCD_write_char(LCD_Obj, str[i]);
        }
    }

    void I2C_LCD_clear(I2C_LCD_t LCD_Obj){
        p_LCD_send_commad(LCD_Obj, 0x01);
        _delay((unsigned long)((1550)*(20000000UL/4000000.0)));
    }

    void I2C_LCD_return_home(I2C_LCD_t LCD_Obj){
        p_LCD_send_commad(LCD_Obj, 0x02);
        _delay((unsigned long)((1550)*(20000000UL/4000000.0)));
    }

    void I2C_LCD_entry_mode(I2C_LCD_t LCD_Obj, uint8_t I_or_D, uint8_t S){
        p_LCD_send_commad(LCD_Obj, 0x04 | I_or_D | S);
        _delay((unsigned long)((1550)*(20000000UL/4000000.0)));
    }

    void I2C_LCD_display_on_off_control(I2C_LCD_t LCD_Obj, uint8_t D, uint8_t C, uint8_t B){
        p_LCD_send_commad(LCD_Obj, 0x08 | D | C | B);
        _delay((unsigned long)((1550)*(20000000UL/4000000.0)));
    }

    void I2C_LCD_cursor_or_display_shift(I2C_LCD_t LCD_Obj, uint8_t S_or_C, uint8_t R_or_L){
        p_LCD_send_commad(LCD_Obj, 0x10 | S_or_C | R_or_L);
        _delay((unsigned long)((1550)*(20000000UL/4000000.0)));
    }

    void I2C_LCD_init(I2C_LCD_t *LCD_Obj_Add, uint8_t I2C_LCD_Address, uint8_t N, uint8_t F){
        LCD_Obj_Add->Address = I2C_LCD_Address;
        LCD_Obj_Add->BackLight_State = 0x08;

        p_LCD_send_commad(*LCD_Obj_Add, 0x32);
        _delay((unsigned long)((1550)*(20000000UL/4000000.0)));
        p_LCD_send_commad(*LCD_Obj_Add, 0x20 | 0x00 | N | F);
        I2C_LCD_display_on_off_control(*LCD_Obj_Add, 0x04, 0x00, 0x00);
        I2C_LCD_entry_mode(*LCD_Obj_Add, 0x02, 0x00);
        p_LCD_send_commad(*LCD_Obj_Add, 0x80);
    }

    void I2C_LCD_set_cursor(I2C_LCD_t LCD_Obj, uint8_t row, uint8_t colomn){
        switch(row){
            case 1:
                p_LCD_send_commad(LCD_Obj, 0x80 + colomn-1); break;
            case 2:
                p_LCD_send_commad(LCD_Obj, 0xC0 + colomn-1); break;
            case 3:
                p_LCD_send_commad(LCD_Obj, 0x94 + colomn-1); break;
            case 4:
                p_LCD_send_commad(LCD_Obj, 0xD4 + colomn-1); break;
        }
    }
    ...
    void I2C_LCD_BackLight_OFF(I2C_LCD_t *LCD_Obj_Add){
        LCD_Obj_Add->BackLight_State= 0x00;
    }
