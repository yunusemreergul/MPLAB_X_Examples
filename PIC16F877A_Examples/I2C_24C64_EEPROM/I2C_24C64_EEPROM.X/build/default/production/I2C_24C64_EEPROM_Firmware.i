...
# 2 "<built-in>" 2
# 1 "I2C_24C64_EEPROM_Firmware.c" 2
...
# 9 "I2C_24C64_EEPROM_Firmware.c" 2
...
# 30 "./I2C_v1.1.h" 2
    ...
    typedef _Bool Slew_Rate_t;




    typedef _Bool SMBus_t;
...
# 10 "I2C_24C64_EEPROM_Firmware.c" 2
...
# 11 "I2C_24C64_EEPROM_Firmware.c" 2

# 1 "./24C64_EEPROM_v1.0.h" 1
# 37 "./24C64_EEPROM_v1.0.h"
...
# 12 "I2C_24C64_EEPROM_Firmware.c" 2
...
# 13 "I2C_24C64_EEPROM_Firmware.c" 2
...
void main(void) {
    ...
    I2C_Master_Initialize(((I2C_BaudRate_t)400000), ((Slew_Rate_t)1), ((SMBus_t)0));
    I2C_LCD_init(&LCD1, 0x40, 0x08, 0x00);
    ...
    I2C_EEPROM_Page_Write(0xA0, EE_Add, writer_data_buffer, 32);
    _delay((unsigned long)((5)*(20000000UL/4000.0)));
    for(int i=0;i<32;i++){
        I2C_EEPROM_Byte_Write(0xA0, (EE_Add+32)+i, 'A');
        _delay((unsigned long)((5)*(20000000UL/4000.0)));
        I2C_EEPROM_Byte_Write(0xA0, (EE_Add+64)+i, 'B');
        _delay((unsigned long)((5)*(20000000UL/4000.0)));
        I2C_EEPROM_Byte_Write(0xA0, (EE_Add+96)+i, 'C');
        _delay((unsigned long)((5)*(20000000UL/4000.0)));
        I2C_EEPROM_Byte_Write(0xA0, (EE_Add+128)+i, 'D');
        _delay((unsigned long)((5)*(20000000UL/4000.0)));
        I2C_EEPROM_Byte_Write(0xA0, (EE_Add+160)+i, 'F');
        _delay((unsigned long)((5)*(20000000UL/4000.0)));
    }
    I2C_LCD_set_cursor(LCD1,3,1);
    I2C_LCD_write_string(LCD1,"I2C EEPROM WRITED.  ");
    _delay((unsigned long)((250)*(20000000UL/4000.0)));
    ...
    while(1){
        if(PORTBbits.RB0==1){
            ...
            for(int i=0;i<32;i++){
                I2C_EEPROM_Byte_Write(0xA0, EE_Add+(32*page_num)+i, 255);I2C_LCD_set_cursor(LCD1,2,1);
                _delay((unsigned long)((5)*(20000000UL/4000.0)));
            }
            I2C_LCD_set_cursor(LCD1,3,2);
        ...
        while(page_num != old_page_num){
            I2C_EEPROM_Sequential_Read(0xA0, EE_Add+(32*page_num), reader_data_buffer_L, 16);
            I2C_EEPROM_Sequential_Read(0xA0, EE_Add+((32*page_num)+16), reader_data_buffer_H, 16);
