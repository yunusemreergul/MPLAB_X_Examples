...
# 9 "USART.c" 2
    ...
    uint8_t Set_BaudRate(uint32_t BaudRateValue)
    {
        ...
        SPRBG_BRGH0 = (20000000UL/(64*BaudRateValue))-1;
        SPRBG_BRGH1 = (20000000UL/(16*BaudRateValue))-1;

        ERROR_BRGH0 = labs(BaudRateValue - (20000000UL/(64*(SPRBG_BRGH0 + 1))));
        ERROR_BRGH1 = labs(BaudRateValue - (20000000UL/(16*(SPRBG_BRGH1 + 1))));
