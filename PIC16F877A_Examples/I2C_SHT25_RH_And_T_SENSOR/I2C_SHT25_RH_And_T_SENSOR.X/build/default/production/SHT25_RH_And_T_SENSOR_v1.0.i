# 1 "SHT25_RH_And_T_SENSOR_v1.0.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "SHT25_RH_And_T_SENSOR_v1.0.c" 2
...
# 9 "SHT25_RH_And_T_SENSOR_v1.0.c" 2
...
# 10 "SHT25_RH_And_T_SENSOR_v1.0.c" 2
# 26 "SHT25_RH_And_T_SENSOR_v1.0.c"
    unsigned int I2C_SHT25_Temperature_Read(void){
        unsigned int Measurement_Buffer[2];
        I2C_Master_Start();
        while(I2C_Master_Write(0x40<<1));
        while(I2C_Master_Write(0xF3));
        I2C_Master_Stop();
        _delay((unsigned long)((100)*(20000000UL/4000.0)));
        I2C_Master_Start();
        while(I2C_Master_Write((0x40<<1)|0x01));
    ...
    unsigned int I2C_SHT25_Relative_Humidity_Read(void){
        ...
        I2C_Master_Start();
        while(I2C_Master_Write(0x40<<1));
        while(I2C_Master_Write(0xF5));
        I2C_Master_Stop();
        _delay((unsigned long)((30)*(20000000UL/4000.0)));
        I2C_Master_Start();
        while(I2C_Master_Write((0x40<<1)|0x01));
        Measurement_Buffer[0] = I2C_Master_Read();
        I2C_Master_Send_ACK();
    ...
    void I2C_SHT25_Soft_Reset(void){
        I2C_Master_Start();
        I2C_Master_Write(0x40<<1);
        I2C_Master_Write(0xFE);
        I2C_Master_Stop();
    }
