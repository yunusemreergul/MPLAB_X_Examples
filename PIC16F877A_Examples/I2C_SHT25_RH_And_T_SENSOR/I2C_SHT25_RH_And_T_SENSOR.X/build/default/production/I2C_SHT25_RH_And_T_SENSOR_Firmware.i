# 1 "I2C_SHT25_RH_And_T_SENSOR_Firmware.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "I2C_SHT25_RH_And_T_SENSOR_Firmware.c" 2
...
# 9 "I2C_SHT25_RH_And_T_SENSOR_Firmware.c" 2
...
# 10 "I2C_SHT25_RH_And_T_SENSOR_Firmware.c" 2
...
# 11 "I2C_SHT25_RH_And_T_SENSOR_Firmware.c" 2

# 1 "./SHT25_RH_And_T_SENSOR_v1.0.h" 1
# 11 "./SHT25_RH_And_T_SENSOR_v1.0.h"
# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\c90\\stdint.h" 1 3
# 11 "./SHT25_RH_And_T_SENSOR_v1.0.h" 2
...
# 12 "I2C_SHT25_RH_And_T_SENSOR_Firmware.c" 2
...
# 13 "I2C_SHT25_RH_And_T_SENSOR_Firmware.c" 2
...
void main(void) {
    ...
    I2C_Master_Initialize(((I2C_BaudRate_t)100000), ((Slew_Rate_t)1), ((SMBus_t)0));
