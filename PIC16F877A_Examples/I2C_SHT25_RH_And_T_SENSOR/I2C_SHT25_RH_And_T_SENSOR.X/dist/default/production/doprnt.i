...
sprintf(char * sp, const char * f, ...)
{
 ...
 unsigned char flag;
# 540 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\sources\\c90\\common\\doprnt.c"
 union {
  unsigned long vd;
  double integ;
 } tmpval;
 ...
 *ap = __va_start();
 ...
 while((c = *f++)) {
  ...
  flag = 0;
# 614 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\sources\\c90\\common\\doprnt.c"
...
# 661 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\sources\\c90\\common\\doprnt.c"
  switch(c = *f++) {
...
# 723 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\sources\\c90\\common\\doprnt.c"
  ...
  case 'i':
   break;
# 776 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\sources\\c90\\common\\doprnt.c"
dostring:
   ...
   continue;
# 810 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\sources\\c90\\common\\doprnt.c"
  case 'c':
# 825 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\sources\\c90\\common\\doprnt.c"
...
# 1331 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\sources\\c90\\common\\doprnt.c"
   for(c = 1 ; c != sizeof dpowers/sizeof dpowers[0] ; c++)
    if(val < dpowers[c])
     break;
# 1371 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\sources\\c90\\common\\doprnt.c"
  if(width && flag & 0x03)
   width--;
# 1407 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\sources\\c90\\common\\doprnt.c"
  if(width > c)
   width -= c;
  else
   width = 0;
