...
void main(void) {
    ...
    for(int i=0;i<4;i++)
    {
        LCD_cursor_or_display_shift(0x08,0x04);
        _delay((unsigned long)((500)*(4000000/4000.0)));
        if (i==3)
        {
            for(int i=0;i<2;i++)
